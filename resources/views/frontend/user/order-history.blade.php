                        ...
                        <div class="card-header-custom">
                            ...
                            <div class="header-actions">
                                <div class="filter-dropdown">
                                    <button class="btn btn-custom-outline btn-sm dropdown-toggle" type="button"
                                    ...
                                    <div class="order-actions">
                                        ...
                                        @elseif($order->status == 3)
                                            ...
                                            <form action="{{ route('order.return', $order) }}" method="POST" class="d-inline">
                                                @csrf
                                                <button type="submit" class="btn btn-custom-warning btn-sm"
                                                    onclick="return confirm('Bạn có chắc muốn trả hàng?')">
