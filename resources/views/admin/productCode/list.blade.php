...
// Delete confirmation
document.querySelectorAll('.delete-productCode').forEach(btn => {
    btn.addEventListener('click', function() {}
        if (confirm('Bạn có chắc chắn muốn xóa mã sản phẩm này?')) {
            const id = this.getAttribute('data-id_productCode');
