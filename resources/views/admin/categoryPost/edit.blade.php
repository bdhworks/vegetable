...
@section('content')
<div class="category-post-edit-page">
    <!-- Page Header -->
    ...
    <div class="form-container">
        <form method="POST" action="{{ route('categoryPost.update', $categoryPost) }}" enctype="multipart/form-data" id="editCategoryForm">
            @csrf
            @method('PUT')
                    ...
                    <div class="content-card">
                        <div class="card-header-custom">
                            <div class="header-left">
                                ...
                                <p class="card-subtitle-custom">Cập nhật thông tin chi tiết cho chuyên mục bài viết</p>
                            </div>
                            <div class="header-right">
                        ...
                        <div class="card-body-custom">
                            ...
                            <div class="form-group-modern">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('name', $categoryPost->name) }}"
                                       required>
                                @error('name')
                            ...
                            <div class="form-group-modern">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('slug', $categoryPost->slug) }}"
                                       required>
                            ...
                            <div class="form-group-modern">
                                ...
                                <textarea class="form-control-modern ckeditor" 
                                          ...
                                          id="desc"
                                          rows="6"
                                          placeholder="Nhập mô tả cho chuyên mục...">{{ old('desc', $categoryPost->desc) }}</textarea>
                                @error('desc')
                                    <div class="error-message">
                                        <i class="ti ti-alert-circle"></i>
                                        <span>{{ $message }}</span>
                            ...
                            <div class="history-timeline">
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        <h6>Tạo mới</h6>
                                        <p>{{ $categoryPost->created_at->format('d/m/Y H:i') }}</p>
                                        <span class="timeline-time">{{ $categoryPost->created_at->diffForHumans() }}</span>
                                    </div>
                                </div>
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <p>{{ $categoryPost->updated_at->format('d/m/Y H:i') }}</p>
                                        <span class="timeline-time">{{ $categoryPost->updated_at->diffForHumans() }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body-custom">
                            ...
                            <div class="form-group-modern">
                                ...
                                <select name="status" class="form-select-modern" required>
                                    ...
                                    <option value="1" {{ old('status', $categoryPost->status) == '1' ? 'selected' : '' }}>
                                        Hiển thị
                                    </option>
                                    <option value="0" {{ old('status', $categoryPost->status) == '0' ? 'selected' : '' }}>
                                        Ẩn
                                    </option>
                                </select>
                                @error('status')
                            ...
                            <div class="info-box">
                                ...
                                <div class="info-content">
                                    <h6>Thông tin</h6>
                                    <ul>
                                        <li><strong>ID:</strong> {{ $categoryPost->id }}</li>
                                        <li><strong>Tạo:</strong> {{ $categoryPost->created_at->format('d/m/Y') }}</li>
                                        <li><strong>Cập nhật:</strong> {{ $categoryPost->updated_at->format('d/m/Y') }}</li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="content-card mt-4">
                        ...
                        <div class="card-body-custom">
                            <div class="preview-box">
                                ...
                                <h6 class="preview-name" id="preview-name">{{ $categoryPost->name }}</h6>
                                <span class="preview-slug" id="preview-slug">{{ $categoryPost->slug }}</span>
...
<form id="deleteForm" action="{{ route('categoryPost.destroy', ['categoryPost_id' => $categoryPost->id]) }}" method="POST" style="display: none;">
    @csrf
    @method('DELETE')
</form>

<style>
/* Category Post Edit Page Styles */
.category-post-edit-page {
    padding: 1.5rem;
    background: #f5f7fa;
    min-height: 100vh;
}
...
function confirmDelete() {
    if (confirm('Bạn có chắc chắn muốn xóa chuyên mục này? Hành động này không thể hoàn tác!')) {
