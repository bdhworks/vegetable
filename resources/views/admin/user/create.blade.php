...
@endsection
@section('title_two')
Quản lý người dùng / Thêm Khách Hàng
@endsection
        ...
        <div class="info-card">
            ...
            <div class="info-body">
                <div class="info-item">
                    ...
                    <div class="info-content">
                        ...
                        <p>Nhập đầy đủ họ tên, email và số điện thoại của khách hàng</p>
                    </div>
                </div>
                <div class="info-item">
                    ...
                    <div class="info-content">
                        ...
                        <p>Email sẽ được sử dụng làm tên đăng nhập vào website</p>
                    </div>
                </div>
                <div class="info-item">
                ...
                <div class="info-item">
                    ...
                    <div class="info-content">
                        <h5>Ảnh Đại Diện</h5>
                        <p>Sử dụng ảnh rõ nét, kích thước tối đa 2MB</p>
                    </div>
                </div>
            </div>
            ...
            <div class="info-footer">
                <div class="tip-box">
                    ...
                    <div>
                        <strong>Lưu ý:</strong> Khách hàng có thể cập nhật thông tin cá nhân sau khi đăng nhập
                    </div>
                </div>
            </div>
        </div>
