...
@endsection
@section('title_two')
Quản lý người dùng / Chỉnh sửa Khách Hàng
@endsection
            ...
            <div class="header-left">
                ...
                <nav class="breadcrumb-modern">
                    <ol>
                        ...
                        <li><a href="{{ route('user.index') }}">Khách hàng</a></li>
                        <li><i class="ti ti-chevron-right"></i></li>
                        <li class="active">Chỉnh sửa #{{ $user->id }}</li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="form-container">
        <div class="content-card">
            <div class="card-header-custom">
                ...
                <div class="header-text">
                    <h3 class="card-title-custom">Thông tin Khách Hàng</h3>
                    <p class="card-subtitle">Cập nhật thông tin cho khách hàng #{{ $user->id }}</p>
                </div>
            ...
            <div class="card-body-custom">
                <form action="{{ route('user.update', $user) }}" method="POST" enctype="multipart/form-data" id="userForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="file-upload-wrapper">
                                ...
                                <label for="image" class="file-label">
                                    ...
                                    <span class="file-text">Chọn ảnh đại diện mới</span>
                                </label>
                                @if($user->avatar)
                                    <div class="current-image">
                                        <img src="{{ $user->avatar }}" alt="Current avatar" id="preview-current">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="text" 
                                       id="status" 
                                       class="form-control" 
                                       value="{{ $user->status == 1 ? 'Hoạt động' : 'Bị khóa' }}"
                                       readonly>
                                <span class="input-icon">
                                    <i class="ti ti-toggle-right"></i>
                                </span>
        ...
        <div class="info-card">
            ...
            <div class="info-body">
                ...
                <div class="info-item">
                    <div class="info-icon {{ $user->status == 1 ? 'success' : 'warning' }}">
                        <i class="ti ti-{{ $user->status == 1 ? 'circle-check' : 'lock' }}"></i>
                    </div>
                    <div class="info-content">
                        <h5>Trạng thái</h5>
                        <p class="info-value">{{ $user->status == 1 ? 'Hoạt động' : 'Bị khóa' }}</p>
                    </div>
                </div>
            </div>
        </div>
