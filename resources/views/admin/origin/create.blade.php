...
<div class="origin-create-page">
    ...
    <div class="form-container">
        <form method="POST" action="{{ route('origin.store') }}">
            @csrf
                ...
                <div class="col-lg-8">
                    <div class="content-card">
                        <div class="card-header-custom">
                            ...
                            <p class="card-subtitle-custom">Nhập thông tin chi tiết cho xuất xứ sản phẩm</p>
                        </div>
                        <div class="card-body-custom">
                            ...
                            <div class="form-group-modern">
                                ...
                                <textarea class="form-control-modern ckeditor" 
                                          ...
                                          id="desc"
                                          rows="6"
                                          placeholder="Nhập mô tả cho xuất xứ...">{{ old('desc') }}</textarea>
                                @error('desc')
                                    <div class="error-message">
                                        <i class="ti ti-alert-circle"></i>
                                        <span>{{ $message }}</span>
                        ...
                        <div class="card-body-custom">
                            ...
                            <div class="info-box">
                                ...
                                <div class="info-content">
                                    <h6>Lưu ý</h6>
                                    <ul>
                                        <li>Tên xuất xứ nên ngắn gọn, rõ ràng</li>
                                        <li>Slug tự động được tạo từ tên</li>
                                        <li>Mô tả giúp khách hàng hiểu rõ hơn</li>
                                        <li>Xuất xứ rõ ràng tăng độ tin cậy</li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="content-card mt-4">
                        ...
                        <div class="card-body-custom">
                            <div class="preview-box">
                                ...
                                <h6 class="preview-name" id="preview-name">Tên xuất xứ</h6>
