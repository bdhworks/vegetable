...
@section('content')
<div class="category-product-create-page">
    <!-- Page Header -->
                ...
                <div class="col-lg-8">
                    <div class="content-card">
                        <div class="card-header-custom">
                            ...
                            <p class="card-subtitle-custom">Nhập thông tin chi tiết cho danh mục sản phẩm</p>
                        </div>
                        ...
                        <div class="card-body-custom">
                            ...
                            <div class="info-box">
                                ...
                                <div class="info-content">
                                    <h6>Lưu ý</h6>
                                    <ul>
                                        <li>Tên danh mục nên ngắn gọn, súc tích</li>
                                        <li>Hình ảnh nên có kích thước chuẩn</li>
                    ...
                    <div class="content-card mt-4">
                        ...
                        <div class="card-body-custom">
                            <div class="preview-box">
                                ...
                                <h6 class="preview-name" id="preview-name">Tên danh mục</h6>
...
<style>
/* Category Product Create Page Styles */
.category-product-create-page {
    padding: 1.5rem;
    background: #f5f7fa;
    min-height: 100vh;
}
...
/* Image Upload Area Specific Styles */
.image-upload-area {
    position: relative;
    min-height: 250px;
