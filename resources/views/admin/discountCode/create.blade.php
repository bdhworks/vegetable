...
@section('content')
<div class="discount-code-create-page">
    <!-- Page Header -->
    ...
    <div class="form-container">
        <form method="POST" action="{{ route('discountCode.store') }}">
            @csrf
                ...
                <div class="col-lg-8">
                    <div class="content-card">
                        <div class="card-header-custom">
                            ...
                            <p class="card-subtitle-custom">Nhập thông tin chi tiết cho mã giảm giá</p>
                        </div>
                        <div class="card-body-custom">
                            ...
                            <div class="form-group-modern">
                                ...
                                <input type="text" 
                                       ...
                                       id="name"
                                       placeholder="VD: SUMMER2024, NEWYEAR50"
                                       value="{{ old('name') }}"
                                       required>
                            ...
                            <div class="form-group-modern">
                                ...
                                <textarea class="form-control-modern ckeditor" 
                                          ...
                                          id="desc"
                                          rows="6"
                                          placeholder="Nhập mô tả chi tiết về chương trình khuyến mãi...">{{ old('desc') }}</textarea>
                                @error('desc')
                                    <div class="error-message">
                                        <i class="ti ti-alert-circle"></i>
                                        <span>{{ $message }}</span>
                        ...
                        <div class="card-body-custom">
                            ...
                            <div class="info-box">
                                ...
                                <div class="info-content">
                                    ...
                                    <ul>
                                        <li>Mã code phải là duy nhất</li>
                                        <li>Không sử dụng ký tự đặc biệt</li>
                                        <li>Tên chương trình rõ ràng, dễ hiểu</li>
                        ...
                        <div class="card-body-custom">
                            <div class="preview-box">
                                <div class="preview-code-badge" id="preview-code-badge">
                                    ...
                                    <span id="preview-code">CODE123</span>
                                </div>
                                <h6 class="preview-title" id="preview-title">Tên chương trình</h6>
                                <p class="preview-hint">Khách hàng sẽ nhập mã này khi thanh toán</p>
                            </div>
                        </div>
                    </div>
                </div>
...
document.getElementById('name')?.addEventListener('input', function() {
    ...
    this.value = code;
    document.getElementById('preview-code').textContent = code || 'CODE123';
});
