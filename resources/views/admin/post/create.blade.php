                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <small class="form-hint">
                                ...
                                Slug được tạo tự động từ tên bài viết
                            </small>
                        </div>
                            ...
                            <div class="input-wrapper">
                                <select name="categoryPost_id" 
                                    ...
                                    @foreach ($categoryPosts as $category)
                                        <option value="{{ $category->id }}" {{ old('categoryPost_id') == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="file-upload-wrapper">
                                ...
                                <label for="image" class="file-label">
                                    ...
                                    <span class="file-text">Chọn hình ảnh bài viết</span>
                                </label>
                                <div class="preview-container" id="preview-container" style="display: none;">
                                    <img id="preview-image" alt="Preview">
                                    <span class="image-label">Xem trước</span>
                                </div>
                            </div>
                            @error('image')
                                <div class="error-message">
        ...
        <div class="info-card">
            ...
            <div class="info-body">
                <div class="info-item">
                    ...
                    <div class="info-content">
                        <h5>Tên Bài Viết</h5>
                        <p>Đặt tên rõ ràng, hấp dẫn để thu hút người đọc</p>
                    </div>
                </div>
                <div class="info-item">
                    ...
                    <div class="info-content">
                        <h5>Danh Mục</h5>
                        <p>Chọn danh mục phù hợp để phân loại bài viết</p>
                    </div>
                </div>
                <div class="info-item">
                    ...
                    <div class="info-content">
                        <h5>Hình Ảnh</h5>
                        <p>Sử dụng ảnh chất lượng cao, kích thước phù hợp</p>
                    </div>
                </div>
                <div class="info-item">
                    ...
                    <div class="info-content">
                        <h5>Nội Dung</h5>
                        <p>Viết nội dung chi tiết, có cấu trúc rõ ràng</p>
                    </div>
                </div>
            </div>
            ...
            <div class="info-footer">
                <div class="tip-box">
                    ...
                    <div>
                        <strong>Mẹo:</strong> Sử dụng các thẻ tiêu đề (H1, H2, H3) để cấu trúc nội dung tốt hơn
                    </div>
                </div>
            </div>
        </div>
...
<style>
/* Post Create Page - No Duplicates from Layout */
.post-create-page {
    padding: 1.5rem;
    min-height: 100vh;
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!name || !slug || !category || !status || !desc || !content || !image) {
            e.preventDefault();
        ...
        // Show loading
        SwalHelper.loading('Đang lưu bài viết...', 'Vui lòng đợi trong giây lát');
    });
